...
manage most  packages. In the future  I'll try to  implement Language Server Protocol  (LSP) support on a  different Git
branch.
...
#+BEGIN_SRC emacs-lisp
  ...
  (custom-set-variables
   ...
   '(package-selected-packages '(htmlize markdown-mode auctex ess which-key yasnippet-snippets yasnippet slime ledger-mode 
  elfeed-org js2-mode web-mode company-php php-mode cider racket-mode move-text restart-emacs company-ghci flycheck-haskell 
  haskell-mode fill-column-indicator zeal-at-point flycheck undo-tree smartparens rainbow-delimiters nord-theme magit 
  org-pomodoro ein go-mode dashboard doom-modeline all-the-icons org-bullets use-package elfeed pdf-tools)))
...
(add-to-list 'recentf-exclude
             (expand-file-name "~/.emacs.d/feeds.org"))

(add-to-list 'recentf-exclude
             (expand-file-name "~/.emacs.d/elfeed/*"))
